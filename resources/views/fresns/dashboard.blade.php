                ...
                <div class="modal-body">
                    <form class="mb-3">
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-outline-secondary installLocal" data-bs-toggle="modal" data-bs-target="#localInstallActionModal" data-bs-dismiss="modal">@lang('fresns.localInstallBtn')</button>
                        </div>
