            ...
            <div class="card-body p-5">
                ...
                <form class="my-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9"><input type="url" class="form-control" placeholder="https://fresns.com" required></div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-sm-9">
                            <button type="submit" class="btn btn-outline-primary">@lang('install.step4Btn')</button>
                        </div>
                    </div>
                </form>
            </div>
