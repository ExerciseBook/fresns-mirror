    ...
    <main class="container">
        <div class="card mx-auto my-5" style="max-width:800px;">
            <div class="card-body p-5">
                <h3 class="card-title">@lang('install.step4Title')</h3>
                <p class="mt-2">@lang('install.step4Desc')</p>
                <form class="my-4">
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">@lang('install.step4BackendHost')</label>
                        <div class="col-sm-9"><input type="url" name="backend_url" class="form-control" placeholder="https://fresns.com" required></div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">@lang('install.step4MemberNickname')</label>
                        <div class="col-sm-9"><input type="text" name="" class="form-control" required></div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">@lang('install.step4AccountEmail')</label>
                        <div class="col-sm-9"><input type="email" name="" class="form-control" required></div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">@lang('install.step4AccountPhoneNumber')</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" name="phoneNumber" class="form-control w-75" required>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">@lang('install.step4AccountPassword')</label>
                        <div class="col-sm-9"><input type="text" name="phone" class="form-control" required></div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-sm-9">
                            <button type="button" id="submit" class="btn btn-outline-primary">@lang('install.step4Btn')</button>
                        </div>
                    </div>
                </form>
            </div>
