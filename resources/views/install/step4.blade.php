...
<body>
            ...
            <div class="card-body p-5">
                ...
                <form class="my-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9"><input type="url" name="backend_host" class="form-control" placeholder="https://fresns.com" required></div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <input type="number" name="pure_phone" class="form-control w-75" required>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" id="install_next" value="{{ route('install.step5') }}" >
    ...
    <script>
        $("#submit").click(function() {
            var backend_host = $('input[name="backend_host"]').val();
            var nickname = $('input[name="nickname"]').val();
            var country_code = $('input[name="country_code"]').val();
            var pure_phone = $('input[name="pure_phone"]').val();
