...
class ErrorCodeService
{
    ...
    private static $CODE_MSG_MAP = [
        ...
        self::ACCOUNT_TOKEN_ERROR                   => '账号 Token 不正确',
        ...
        // Account
        self::REGISTER_ERROR                        => '该注册通道已关闭，禁止通过此功能注册账号',
        self::REGISTER_EMAIL_ERROR                  => '不支持邮箱注册',
        self::REGISTER_PHONE_ERROR                  => '不支持手机号注册',
        self::REGISTER_ACCOUNT_ERROR                => '该账号已注册',
        ...
        self::ACCOUNT_VERIFY_ERROR                  => '账号密码或者验证码不能全部为空',
        self::ACCOUNT_PASSWORD_INVALID              => '账号密码不正确',
        self::ACCOUNT_LOGIN_ERROR                   => '账号不正确或者密码错误',
        self::ACCOUNT_COUNT_ERROR                   => '错误已超系统限制，请 1 小时后再登录',

        self::ACCOUNT_ERROR                         => '该账号已注销',
        self::ACCOUNT_IS_ENABLE_ERROR               => '当前账号已被禁用',
        self::ACCOUNT_WALLETS_ERROR                 => '账号钱包不存在',
        self::ACCOUNT_BALANCE_ERROR                 => '钱包余额不允许支付',
        self::BALANCE_CLOSING_BALANCE_ERROR         => '期末余额和钱包额度不匹配',
        self::TO_ACCOUNT_WALLETS_ERROR              => '对方钱包不存在',
        self::TO_BALANCE_CLOSING_BALANCE_ERROR      => '对方期末余额和钱包额度不匹配',

        // User
        self::USER_FAIL                             => '当前用户不存在或者不属于当前账号',
        self::USER_ERROR                            => '该用户已注销',
        self::USER_IS_ENABLE_ERROR                  => '当前用户已被禁用',
        self::USER_PASSWORD_INVALID                 => '密码不正确',
        self::USER_EXPIRED_ERROR                    => '用户已过期，无权操作该功能',
        self::USER_NO_PERMISSION                    => '当前用户无权请求',
        self::USER_NICKNAME_ERROR                   => '昵称格式错误，请勿使用特殊字符',
        self::USER_NICKNAME_LENGTH_ERROR            => '昵称长度超出限制',
        self::USER_NAME_ERROR                       => '名称格式错误，请勿使用特殊字符',
        self::USER_NAME_USED_ERROR                  => '该名称已被使用',
        self::USER_NAME_LENGTH_ERROR                => '名称长度不符合要求',
        ...
        self::ROLE_NO_PERMISSION_UPLOAD_DOCUMENT    => '当前角色无权上传文档',
        ...
        // Dialog
        self::DIALOG_ERROR                          => '会话异常或者该会话不属于当前用户',
        self::DIALOG_MESSAGE_ERROR                  => '消息已删除',
        self::SEND_ME_ERROR                         => '自己不能给自己发送信息',
        self::FILE_OR_TEXT_ERROR                    => '单个消息只能「文件」或「文本」二选一',
        self::DIALOG_LIMIT_2_ERROR                  => '对方已设置仅允许 TA 关注的用户才能给 TA 发送消息',
        self::DIALOG_LIMIT_3_ERROR                  => '对方已设置仅允许 TA 关注的用户和已认证的用户才能给 TA 发送消息',
        ...
        self::GROUP_POST_ALLOW_ERROR                => '当前用户无该小组的发帖权限',
        self::GROUP_COMMENTS_ALLOW_ERROR            => '当前用户无该小组的评论权限',
        ...
        // Editor Check Parameters
        self::USER_LIST_JSON_ERROR                  => 'userListJson 格式错误或者数据异常',
