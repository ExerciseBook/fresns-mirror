...
class PluginController extends Controller
{
    ...
    public function engineIndex()
    {
        ...
        return view('panel::client.engines', compact(
            'engines', 'configs', 'themes'
        ));
    }
    ...
    public function updateEngineTheme(Plugin $engine, Request $request)
    {
        ...
        if ($request->has($pcKey)) {
            if (!$pcConfig) {
                ...
                $pcConfig->item_type = 'plugin';
                $pcConfig->item_tag = 'engines';
        ...
        if ($request->has($mobileKey)) {
            if (!$mobileConfig) {
                ...
                $mobileConfig->item_type = 'plugin';
                $mobileConfig->item_tag = 'engines';
    ...
    public function themeIndex()
    {
        ...
        return view('panel::client.themes', compact(
            'themes'
        ));
    }
    ...
    public function appIndex()
    {
        ...
        return view('panel::client.apps', compact(
            'apps'
        ));
    }
