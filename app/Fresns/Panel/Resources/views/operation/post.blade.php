...
@section('content')
  ...
  <form action="{{ route('panel.postConfigs.update') }}" method="post">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 pt-2">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" name="post_email_verify" id="comment_email_verify" value="1">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6 pt-2">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="post_limit_status" id="post_limit_status_0" value="0" data-bs-toggle="collapse" data-bs-target="#post_limit_setting.show" aria-expanded="false" aria-controls="post_limit_setting" checked>
          <label class="form-check-label" for="post_limit_status_0">关闭特殊规则</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="post_limit_status" id="post_limit_status_1" value="1" data-bs-toggle="collapse" data-bs-target="#post_limit_setting:not(.show)" aria-expanded="false" aria-controls="post_limit_setting">
          <label class="form-check-label" for="post_limit_status_1">开启特殊规则</label>
        </div>
        <!--发表帖子特殊规则配置 开始-->
        <div class="collapse mt-3" id="post_limit_setting">
          <div class="input-group mb-3">
            <label class="input-group-text fresns-label">规则类型</label>
            <select class="form-select" id="post_limit_status">
    ...
    <div class="row mb-5">
      ...
      <div class="col-lg-6 pt-2">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="post_edit_status" id="post_edit_status_0" value="0" data-bs-toggle="collapse" data-bs-target="#post_edit_setting.show" aria-expanded="false" aria-controls="post_edit_setting" checked>
          <label class="form-check-label" for="post_edit_status_0">不可编辑</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="post_edit_status" id="post_edit_status_1" value="1" data-bs-toggle="collapse" data-bs-target="#post_edit_setting:not(.show)" aria-expanded="false" aria-controls="post_edit_setting">
          <label class="form-check-label" for="post_edit_status_1">可以编辑</label>
        </div>
        <!--发表帖子特殊规则配置 开始-->
        <div class="collapse mt-3" id="post_edit_setting">
          <div class="input-group mb-3">
            <label class="input-group-text">多长时间内可以编辑</label>
            <input type="number" class="form-control input-number" id="post_edit_timelimit" value="30">
          ...
          <div class="input-group mb-3">
            ...
            <div class="form-control bg-white">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="post_edit_sticky" id="post_edit_sticky_false" value="false" checked>
                <label class="form-check-label" for="post_edit_sticky_false">不可编辑</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="post_edit_sticky" id="post_edit_sticky_true" value="true">
          ...
          <div class="input-group mb-3">
            ...
            <div class="form-control bg-white">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="post_edit_essence" id="post_edit_essence_false" value="false" checked>
                <label class="form-check-label" for="post_edit_essence_false">不可编辑</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="post_edit_essence" id="post_edit_essence_true" value="true">
      ...
      <div class="col-lg-10">
        <ul class="list-group">
          <li class="list-group-item">
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" id="editor_group" checked>
              <label class="form-check-label" for="editor_group">小组</label>
            </div>
            <div class="form-check form-check-inline">
              <input type="checkbox" class="form-check-input" id="editor_title" checked>
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <div class="form-control bg-white">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_group_required" id="post_editor_group_required_false" value="false" checked>
              <label class="form-check-label" for="post_editor_group_required_false">否</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_group_required" id="post_editor_group_required_true" value="true">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <div class="form-control bg-white">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_title_view" id="post_editor_title_view_false" value="false" checked>
              <label class="form-check-label" for="post_editor_title_view_false">弱显示</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_title_view" id="post_editor_title_view_true" value="true">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <div class="form-control bg-white">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_title_required" id="post_editor_title_required_false" value="false" checked>
              <label class="form-check-label" for="post_editor_title_required_false">否</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="post_editor_title_required" id="post_editor_title_required_true" value="true">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <input type="number" class="form-control input-number" id="post_editor_title_word_count" value="60">
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <input type="number" class="form-control input-number" id="post_editor_word_count" value="10000">
          <span class="input-group-text">字符</span>
        </div>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-lg-6">
        <div class="input-group">
          ...
          <input type="number" class="form-control input-number" id="post_editor_brief_count" value="280">
          <span class="input-group-text">字符</span>
        </div>
      </div>
