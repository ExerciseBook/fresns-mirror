    ...
    <main class="form-signin text-center">
        <form method="post" class="p-3" action="{{ route('panel.login') }}">
            ...
            <div class="form-floating">
                <input type="text" class="form-control rounded-bottom-0" name="accountName" value="{{ old('accountName') }}" readonly placeholder="name@example.com">
                <label for="account">{{ __('FsLang::panel.account') }}</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control rounded-top-0 border-top-0" name="password" readonly placeholder="Password">
