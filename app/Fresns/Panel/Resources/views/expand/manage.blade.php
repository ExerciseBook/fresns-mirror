	...
	<table class="table table-hover align-middle text-nowrap">
		...
		<tbody>
			<tr>
				...
				<td>投诉插件</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 投诉</td>
				<td><span class="badge bg-light text-dark">帖子</span> <span class="badge bg-light text-dark">评论</span> <span class="badge bg-light text-dark">用户</span></td>
				<td></td>
			...
			<tr>
				...
				<td>表单插件</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 有奖投稿</td>
				<td><span class="badge bg-light text-dark">帖子</span></td>
			...
			<tr>
				...
				<td>表单插件</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 建议反馈</td>
				<td><span class="badge bg-light text-dark">帖子</span> <span class="badge bg-light text-dark">评论</span> <span class="badge bg-light text-dark">用户</span></td>
				<td></td>
				<td><i class="bi bi-dash-lg text-secondary"></i></td>
				<td>feedback</td>
			...
			<div class="modal-body">
				<form>
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-9 pt-2">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="usages" id="usage_role" value="true" data-bs-toggle="collapse" data-bs-target="#usage_setting:not(.show)" aria-expanded="false" aria-controls="usage_setting" checked>
								<label class="form-check-label" for="usage_role">全局</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="usages" id="usage_group" value="false" data-bs-toggle="collapse" data-bs-target="#usage_setting.show" aria-expanded="false" aria-controls="usage_setting">
