	...
	<table class="table table-hover align-middle text-nowrap">
		...
		<tbody>
			<tr>
				...
				<td><span class="badge rounded-pill bg-secondary">互联网的解忧杂货铺</span></td>
				<td>纯链接扩展插件</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 解忧指南</td>
				<td></td>
				<td>https://tangjie.me/zhinan</td>
			...
			<tr>
				...
				<td><span class="badge rounded-pill bg-secondary">产品经理的日常</span></td>
				<td>榜单插件</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 每周热门</td>
				<td></td>
				<td>weeks</td>
