	...
	<div class="col-lg-3">
		<div class="input-group mt-2 mb-4 justify-content-lg-end">
			<button class="btn btn-primary"
	                ...
	                data-action="{{ route('panel.expandEditor.store') }}"
...
<div class="table-responsive">
	<table class="table table-hover align-middle text-nowrap">
		...
		<tbody>
			...
			<tr>
				<td><input type="number"  data-action="{{ route('panel.expandEditor.rank',$item->id) }}" class="form-control input-number rank-num" value="{{ $item['rank_num']}}"></td>
...
<form action="" method="post">
  ...
  <input type="hidden" name="update_name" value="0">
	<!-- Create Modal -->
	<div class="modal fade name-lang-parent expend-edit-modal" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
