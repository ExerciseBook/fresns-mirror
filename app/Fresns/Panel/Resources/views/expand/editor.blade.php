...
<div class="row mb-4 border-bottom">
	<div class="col-lg-9">
		<h3>编辑器扩展</h3>
		<p class="text-secondary">将呈现在发布流程的「编辑器」中，例如「投票」扩展可以让「编辑器」支持为帖子附带投票功能。</p>
	</div>
	<div class="col-lg-3">
	...
	<table class="table table-hover align-middle text-nowrap">
		<thead>
			<tr class="table-info">
				...
				<th scope="col">使用数量 <i class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="以“投票”插件举例，数量为 2 则代表单个帖子可以附带 2 个投票"></i></th>
		...
		<tbody>
			<tr>
				...
				<td>豆瓣电影</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 插个电影</td>
				<td><span class="badge bg-light text-dark">帖子</span> <span class="badge bg-light text-dark">评论</span></td>
				<td>3</td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td>悬赏</td>
				<td><img src="../assets/images/temp/placeholder_icon.png" width="24" height="24"> 有奖活动</td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
					...
					<div class="mb-3 row">
						<label class="col-sm-3 col-form-label">使用数量</label>
						<div class="col-sm-9">
							<input type="number" class="form-control input-number" value="1" max="10">
						</div>
					</div>
					<div class="mb-3 row">
