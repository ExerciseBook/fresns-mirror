...
@section('content')
    ...
    <div class="col-lg-3">
      <div class="input-group mt-2 mb-4 justify-content-lg-end">
        <button class="btn btn-primary" type="button"
                                        ...
                                        data-action="{{ route('panel.expandProfile.store') }}"
                                        data-bs-target="#createModal">
          <i class="bi bi-plus-circle-dotted"></i> 新增扩展</button>
    ...
    <table class="table table-hover align-middle text-nowrap">
      ...
      <tbody>
        @foreach($pluginUsages as $item)
          <tr>
            <td><input type="number"  data-action="{{ route('panel.expandProfile.rank',$item->id) }}" class="form-control input-number rank-num" value="{{ $item['rank_num']}}"></td>
            ...
            <td>
              <form action="{{ route('panel.expandProfile.destroy',$item->id) }}" method="post">
                @csrf
                @method('delete')
                <button type="button" class="btn btn-outline-primary btn-sm"
                                      ...
                                      data-action="{{ route('panel.expandProfile.update', $item->id) }}"
  ...
  <form action="" method="post">
    ...
    <div class="modal fade  name-lang-parent expend-profile-modal" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">用户资料扩展</h5>
