        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-10 mb-3">
                <ul class="list-group">
                    ...
                    <!--user-->
                    <li class="list-group-item">
                        <span class="badge text-bg-warning">{{ __('FsLang::panel.user') }}</span>
                        <div class="form-check form-check-inline">
                    ...
                    <!--group-->
                    <li class="list-group-item">
                        <span class="badge text-bg-warning">{{ __('FsLang::panel.group') }}</span>
                        <div class="form-check form-check-inline">
                    ...
                    <!--hashtag-->
                    <li class="list-group-item">
                        <span class="badge text-bg-warning">{{ __('FsLang::panel.hashtag') }}</span>
                        <div class="form-check form-check-inline">
                    ...
                    <!--post-->
                    <li class="list-group-item">
                        <span class="badge text-bg-warning">{{ __('FsLang::panel.post') }}</span>
                        <div class="form-check form-check-inline">
                    ...
                    <!--comment-->
                    <li class="list-group-item">
                        <span class="badge text-bg-warning">{{ __('FsLang::panel.comment') }}</span>
                        <div class="form-check form-check-inline">
