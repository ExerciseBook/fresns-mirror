        ...
        <div class="container-fluid d-lg-flex flex-lg-column">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav d-flex flex-column">
                    ...
                    <li><hr style="margin: 0.5rem 0"></li>
                    <li class="nav-item"><a class="nav-link {{ \Route::is('panel.iframe.marketplace') ? 'active' : '' }}" href="{{ route('panel.iframe.marketplace', ['url' => 'https://market.fresns.cn/open-source']) }}"><i class="bi bi-shop"></i> {{ __('FsLang::panel.menu_marketplace') }}</a></li>
