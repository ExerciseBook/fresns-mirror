...
return [
    ...
    */
    ...
    'menu_table_query_status' => 'Client Query Param',
    'menu_table_query_status_desc' => 'Whether or not to accept client-side passes, when turned off only the default parameter values will be supported',
