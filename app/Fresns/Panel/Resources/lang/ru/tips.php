...
return [
    ...
    */
    ...
    // auth empty
    'auth_empty_title' => 'Пожалуйста, используйте правильный портал для входа в консоль',
    'auth_empty_description' => 'Вы вышли из системы и не можете получить доступ к странице консоли, пожалуйста, зайдите на портал доступа для входа в систему.',
    // request
