...
return [
    ...
    */
    ...
    'app_ios_desc' => 'Função de notificação pop-up do sistema iOS',
    'app_android_config' => 'Configuração do Android',
    'app_android_desc' => 'Função de notificação pop-up do sistema Android',
    'app_wechat_config' => 'Configuração do Wechat',
    'app_wechat_desc' => 'Notificação de serviço Wechat ou mensagem de modelo de número público',
    // App-Center-Keys
